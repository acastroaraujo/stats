...
Instead of a simple independence assumption that we have for randomized experiments, we now have to rely on a **conditional independence assumption** (CIA), like in regression.
